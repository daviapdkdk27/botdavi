...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:LORDE SCREAMO\n'
            + 'ORG:Owner CAFE 𝙱𝙾𝚃;\n'
            + 'TEL;type=CELL;type=VOICE;waid=558799551918:+55 87 9955-1918\n'
            + 'END:VCARD'
...
prefix = "!"
name = "Screamobot"
rdaftar = "OBRIGADO POR SE REGISTAR PARA SER UM USUÁRIO DO BOT 😁"
rmenu = "Oi amigo bot 👋🏻 NÃO SE ESQUEÇA NAO PAGUE POR BOTS:)"
botinfo = "PARA BOTS CONVIDADOS, TODOS BOTS TERMUX SAO INDONÉSIO NENHUM BR CRIA SÓ EDITA:)"
limitt = 999999999
memberLimit = 2
ban = []
premium = ["558799551918@s.whatsapp.net","5558799551918@s.whatsapp.net"]
		...
		if(antifake.includes(anu.jid)) {
			if (anu.action == 'add'){
				...
				if(!num.split('@')[0].startsWith(55)) {
					denz.sendMessage(mdata.id, 'SEM NUMERO FAKE AQUI FDP', MessageType.text)
...
┏━━━━━━━━━━━━━━━
┃ㅤ           ✨⃟⃝🌹͟𝐁𝐄𝐌 𝐕𝐈𝐍𝐃𝐎 𝐀 𝐆𝐒 🦅⃟💸

✨⃟⃝🌴 𝑆𝐸𝐽𝐴 𝐴𝑇𝐼𝑉𝑂 𝑁𝑂 𝐺𝑃 
✨⃟⃝💸 𝑈𝑆𝐸 𝑁𝑂𝑆𝑆𝐴 𝑇𝐴𝐺 𝑃𝑅𝐴 𝑇𝐸𝑅 𝑀𝑂𝑅𝐴𝐿 𝐶𝑂𝑀 𝑂𝑆 𝐴𝐷𝑀 -  🦅⃟࿊⃟💸
✨⃟⃝🔥 𝑅𝐸𝑀𝑂𝐶𝐴𝑂 𝐷𝐸 𝐺𝐻𝑂𝑆𝑇 𝑇𝑂𝐷𝑂 𝐷𝐼𝐴
...
ᴅɪɢɪᴛᴇ ${prefix}daftar ᴘᴀʀᴀ ᴄᴏᴍᴇᴄᴀʀ ᴀ ᴜsᴀʀ  ʙᴏᴛ`
	...
	denz.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '*⏳ ᴇsᴘᴇʀᴇ ᴛᴏᴍᴇ  ᴜᴍ ᴄᴀғᴇ ☕ ᴇɴǫᴜᴀɴᴛᴏ ᴠᴏᴜ ᴛᴇ ᴇɴᴄᴀʀᴄᴀʀ ᴅᴇ ᴘᴇ...*',
				success: '*sᴜᴄᴇssᴏ...*',
				error: {
			...
			const ownerNumber = ["558799551918@s.whatsapp.net","558799551918@s.whatsapp.net","558799551918@s.whatsapp.net"] // owner number ubah aja
...
denz.sendMessage(from, hasil, text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "ketik #menu kak", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
		...
		setTimeout( () => {
		reply(`*_「 𝑃𝑎𝑙𝑎𝑣𝑟𝑎 𝑜𝑓𝑒𝑛𝑠𝑖𝑣𝑎 𝐷𝑒𝑡𝑒𝑐𝑡𝑎𝑑𝑎」_*\n𝐷𝑒𝑠𝑐𝑢𝑙𝑝𝑒 *${pushname2}* ᴀɴᴅᴀ ʙᴇʀʙɪᴄᴀʀᴀ ᴋᴏᴛᴏʀ!, ᴀɴᴅᴀ ꜱᴇɢᴇʀᴀ ᴅɪᴋɪᴄᴋ ᴅᴀʀɪ ɢʀᴜᴘ *${groupMetadata.subject}*`)
		}, 0)
		}
			...
			if (!isCmd && isGroup) console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;31mRECV\x1b[1;37m]', time, color('Message'), 'from', color(sender.split('@')[0]), 'in', color(groupName), 'args :', color(args.length))
                ...
                switch(command) {
					...
					if (Number(args[0]) === 1) {
						...
						reply('PRONTO AGR OS FDP DE FAKE NÃO ENTRARAM✔️')
